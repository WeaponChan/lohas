...
@interface CountrySearchViewController ()<cityPickerDelegate,selectTypeDelegate>{
...
-(void)actSearch{
    ...
    if (isListBack) {
        ...
        [self.delegate viewPop:@"" city_id:selectCityID type_id:categoryID];
