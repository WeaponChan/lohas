...
@interface CountryTypeViewController (){
...
@implementation CountryTypeViewController
@synthesize categoryStr,backSelectBtn,Stitle;
...
//    self.mCountryTypeList.categoryStr=categoryStr;
//    [self.mCountryTypeList initial:self];
