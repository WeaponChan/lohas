...
@implementation CountryViewList
@synthesize countryInfo,selectID,comment_numDic,photoList,categoryStr,isHideMore;
...
-(void) asyncLoadData
{
    ...
    switch (actionType) {
        ...
        case ACTION_TYPE_PULLREFRESH:{
            ...
            if ([parent isKindOfClass:[CountryViewController class]]) {
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (type.intValue) {
        case 0:
            ...
            return [CountryTitleCell Height:item];
            
            break;
            
        case 1:
            
            return [CountryInfoCell Height:item];
            
            break;
            
        case 2:
            
            return [CountryTextCell Height:countryInfo isHide:isHideMore];
...
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        switch (type.intValue) {
            case 0:
            {
                cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"CountryTitleCell"];
                
                CountryTitleCell *mCountryTitleCell = (CountryTitleCell *)cell;
                mCountryTitleCell.countryInfo=countryInfo;
                mCountryTitleCell.headDic=self.HeadDic;
                mCountryTitleCell.categoryStr=categoryStr;
            ...
            case 1:
            {
                cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"CountryInfoCell"];
                
                CountryInfoCell *mCountryInfoCell = (CountryInfoCell *)cell;
                mCountryInfoCell.countryInfo=countryInfo;
                mCountryInfoCell.categoryStr=categoryStr;
            ...
            case 5:
            {
                ...
                if ([categoryStr isEqual:@"food"]) {
                    mPlaceViewCell.type=4;
                }else{
                    mPlaceViewCell.type=1;
                }
