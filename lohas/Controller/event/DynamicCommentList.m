...
@implementation DynamicCommentList
@synthesize said_id;
...
-(void) asyncLoadData
{
    ...
    [api saidCommentList:pageIndex limit:pageSize said_id:said_id];
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [DynamicCommentCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"DynamicCommentCell"];
        DynamicCommentCell *mEventListCell = (DynamicCommentCell *)cell;
