...
-(void) asyncLoadData
{
    ...
    Api* api = [[Api alloc] init:self tag:@"messageList"];
    [api messageList:pageIndex limit:pageSize];
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [DyMessageCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"DyMessageCell"];
        DyMessageCell *mEventListCell = (DyMessageCell *)cell;
