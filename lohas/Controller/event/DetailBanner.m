...
- (void)initScroll
{
    ...
    for (int i=0; i<count; i++) {
        ...
        NSArray *nib = [[NSBundle mainBundle] loadNibNamed:@"DetailBannerItem" owner:self options: nil];
        DetailBannerItem *view = (DetailBannerItem *)[nib objectAtIndex: 0];
        [view update:dict Parent:parent];
        
        view.frame = CGRectMake(pageWidth*i, 0, pageWidth, pageHeight);
