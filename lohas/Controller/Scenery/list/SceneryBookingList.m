...
#import "SceneryBookingList.h"
#import "SceneryBookingCell.h"

@implementation SceneryBookingList
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [SceneryBookingCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"SceneryBookingCell"];
        SceneryBookingCell *mSceneryBookingCell = (SceneryBookingCell *)cell;
        NSDictionary *item = [dataList objectAtIndex:indexPath.row];
        [mSceneryBookingCell update:item Parent:parent];
    }
