...
@implementation HotelBookingList
@synthesize plans,headTitle;
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [HotelBookingCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"HotelBookingCell"];
        HotelBookingCell *mHotelBookingCell = (HotelBookingCell *)cell;
        NSDictionary *item = [dataList objectAtIndex:indexPath.row];
        mHotelBookingCell.sdate=self.sdate;
        mHotelBookingCell.edate=self.edate;
        mHotelBookingCell.ListItem=self.ListItem;
        mHotelBookingCell.headTitle=headTitle;
        [mHotelBookingCell update:item Parent:parent];
    }
