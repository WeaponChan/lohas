...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [FoodGroupCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"FoodGroupCell"];
        FoodGroupCell *mFoodGroupCell = (FoodGroupCell *)cell;
        NSDictionary *item = [dataList objectAtIndex:indexPath.row];
        [mFoodGroupCell update:item Parent:parent];
    }
