...
@interface WapFlightViewController ()<flightsCityDelegate,DayPickerDelegate>{
    NSString *SCode;
    NSString *ECode;
    NSString *nowDate;
    NSString *SFlag;
...
@implementation WapFlightViewController
...
- (IBAction)actClickRight:(id)sender {
    @try{
        ...
        [self performBlock:^{
            WapTrainViewController*viewCtrl=[[WapTrainViewController alloc]initWithNibName:@"WapViewController" bundle:nil];
            viewCtrl.hidesBottomBarWhenPushed = YES;
