...
#import "FlightsBookingList.h"
#import "FlightsBookingCell.h"

@implementation FlightsBookingList
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [FlightsBookingCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
- (UITableViewCell *)tableView:(UITableView *)mtableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (dataList.count == 0) {
        ...
        cell=[MSUIUtils newCellByNibName: mtableView  NibName:@"FlightsBookingCell"];
        FlightsBookingCell *mFlightsBookingCell = (FlightsBookingCell *)cell;
        NSDictionary *item = [dataList objectAtIndex:indexPath.row];
        [mFlightsBookingCell update:item Parent:parent];
    }
