...
@implementation mainAddList
@synthesize selectList,isDelete,isEdit;
...
-(void) asyncLoadData
{
    ...
    [self requestSucceeded:selectList];
    NSLog(@"selectList=======%@",selectList);
...
- (CGFloat)tableView:(UITableView *)mtableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    return [TripCell Height:[dataList objectAtIndex:indexPath.row]];
}
//设置某个cell对象
